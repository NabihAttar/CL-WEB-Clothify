	...
	const features = [
		{
			...
			desc: "We build software tailored to your business goals, workflow, and daily operations.",
			icon: (
				<svg
					width="81"
					height="81"
		...
		},
		{
			...
			desc: "We use reliable tools and clean development practices to deliver scalable digital products.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "Every project starts with clear analysis, planning, and a roadmap for successful execution.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "Our solutions help companies save time, reduce manual work, and grow with confidence.",
			icon: (
				<svg
					width="80"
					height="81"
