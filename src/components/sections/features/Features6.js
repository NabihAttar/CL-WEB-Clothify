...
const Features6 = () => {
	...
	const features = [
		{
			title: "Fast Delivery",
			desc: "We build efficient digital solutions with clean planning, modern tools, and a smooth development process.",
			icon: (
				<svg
					width="81"
					height="81"
		...
		},
		{
			...
			desc: "Every website, ERP, POS, mobile app, or desktop system is designed around your business needs.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "Our solutions are built to grow with your company, from small business tools to advanced management systems.",
			icon: (
				<svg
					width="80"
					height="81"
		...
		},
		{
			...
			desc: "We help reduce manual work, improve workflows, and make daily business operations easier to manage.",
			icon: (
				<svg
					width="80"
					height="81"
					...
					<div className="col-lg-4 ">
						<div className="sec-heading h8-section-heading style-4">
							...
							<div className="desc wow fadeInUp" data-wow-delay="0.7s">
								<p>
								We deliver smart, scalable, and reliable software solutions that help businesses simplify operations and grow faster.
								</p>
							</div>
